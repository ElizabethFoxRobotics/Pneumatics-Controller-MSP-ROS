...
const int presAdc[NUM_PRES_SENSOR] = {0,4};//{0,1,3,5,4}; // ADC channel corresponding to pressure
...
float pres_des[NUM_PRES_SENSOR];
float pres_options[4];

float prev_error[NUM_PRES_SENSOR];
int ctrlcount = 0;
