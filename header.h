...
#define PWM_PERIOD 150000 //33333 // pulse-width modulation timer period
...
#define NUM_PRES_SENSOR 2 //5  // number of pressure sensors; 5 max based on number of provided PWM signals
...
extern float pres_options[4];
extern float prev_error[NUM_PRES_SENSOR];
